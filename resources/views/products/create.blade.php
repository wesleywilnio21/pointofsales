                        ...
                        <div class="mt-6 border-t pt-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="bulk_unit" value="{{ old('bulk_unit') }}" placeholder="e.g. Sack or Box" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Conversion Factor</label>
                                    <input type="number" step="0.01" name="conversion_factor" value="{{ old('conversion_factor') }}" placeholder="e.g. 25 (if 1 Sack = 25 kg)" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Bulk Selling Price</label>
                                    <input type="number" step="0.01" name="bulk_price" value="{{ old('bulk_price') }}" placeholder="e.g. 700000" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                </div>
                            </div>
                        </div>
