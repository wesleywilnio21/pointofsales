            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                <template x-for="product in filteredProducts" :key="product.id">
                    <div @click="addToCart(product)" 
                         class="border border-gray-200 rounded-xl p-4 cursor-pointer hover:shadow-lg hover:border-blue-300 transition bg-white flex flex-col justify-between relative overflow-hidden group">
                        ...
                        <div class="mb-2">
                            <h3 class="font-bold text-lg text-gray-800 leading-tight" x-text="product.name"></h3>
                            <p class="text-xs text-gray-500 uppercase tracking-wide mt-1" x-text="product.category"></p>
                        </div>
                        <div class="mt-4 flex justify-between items-end">
                            <span class="text-xl font-extrabold text-blue-600" x-text="formatCurrency(product.sell_price)"></span>
                ...
                <div x-show="filteredProducts.length === 0" class="col-span-full text-center text-gray-500 py-8">
                    ...
                    <div class="bg-gray-50 p-3 rounded-lg border border-gray-100 flex justify-between items-center">
                        <div class="flex-1">
                            ...
                            <div class="flex items-center space-x-3 mt-2">
                                ...
                                <span class="font-bold text-gray-700 w-4 text-center" x-text="item.quantity"></span>
            ...
            <div class="border-t border-gray-200 pt-4 mt-auto">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" x-model.number="cashReceived" class="pl-8 shadow-sm border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-700 font-bold text-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="0.00" min="0" step="0.01">
                    </div>
                </div>
